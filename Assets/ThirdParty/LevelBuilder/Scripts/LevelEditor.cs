...
namespace ThirdPixelGames.LevelBuilder
{
    ...
    /// <summary>
    /// The editor script that simplifies the curLevel design
    /// </summary>
    ...
    public class LevelEditor : Editor
    {
        ...
        /// <summary>
        /// The scale value inside the curLevel object
        /// </summary>
        private SerializedProperty _scale;

        /// <summary>
        /// The Size X value inside the curLevel object
        /// </summary>
        private SerializedProperty _sizeX;

        /// <summary>
        /// The Size Y value inside the curLevel object
        /// </summary>
        private SerializedProperty _sizeY;

        /// <summary>
        /// The Palette value inside the curLevel object
        /// </summary>
        private SerializedProperty _savedPalette;

        /// <summary>
        /// The Level Data value inside the curLevel object
        /// </summary>
        private SerializedProperty _levelData;

        /// <summary>
        /// The Overlay Data value inside the curLevel object
        /// </summary>
        ...
        /// <summary>
        /// The Additional Layer Data value inside the curLevel object
        /// </summary>
        ...
        /// <summary>
        /// Show/hide the curLevel data grid
        /// </summary>
        ...
        {
            // Find the properties we need to build a curLevel
            ...
            _sizeZ = serializedObject.FindProperty("sizeZ");
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Edit the curLevel name
            EditorGUILayout.PropertyField(_levelName);
            
            // Edit the curLevel type
            ...
            _sizeZ.intValue = Mathf.Max(_sizeZ.intValue, 1);
            ...
            // Try to load the saved curLevel data
            ...
            var additionalLayerCount = Mathf.Max(_sizeZ.intValue - 1, 0);

            // Initialize the additional data visiblity flags
            if (_showAdditionalData == null || _showAdditionalData.Length != additionalLayerCount)
            {
                _showAdditionalData = new bool[additionalLayerCount];
            }

            // Try to load the saved additional layer data
            var additionalLayers = new List<LevelData[]>();

            for (var i = 0; i < additionalLayerCount; i++)
            {
                // Get the layer data
                ...
                additionalLayers.Add(GenerateGrid(additionalLayerData, ref _showAdditionalData[i],
                    $"Z Layer {i + 1}", _sizeX.intValue, _sizeY.intValue));
            }
        ...
        /// <summary>
        /// Get a list of curLevel data (or empty curLevel data if nothing is saved)
        /// </summary>
        /// <param name="json">The saved curLevel data</param>
        /// <param name="sizeX">The horizontal size of the curLevel</param>
        /// <param name="sizeY">The vertical size of the curLevel</param>
        /// <returns>An array of empty curLevel data</returns>
        ...
        /// <summary>
        /// Surround the curLevel with the selected palette item
        /// </summary>
        /// <param name="data">The current curLevel data</param>
        /// <param name="sizeX">The horizontal size of the curLevel</param>
        /// <param name="sizeY">The vertical size of the curLevel</param>
        ...
        /// <summary>
        /// Fill the empty tiles of the curLevel with the selected palette item
        /// </summary>
        /// <param name="data">The current curLevel data</param>
        /// <param name="sizeX">The horizontal size of the curLevel</param>
        /// <param name="sizeY">The vertical size of the curLevel</param>
        ...
        /// <summary>
        /// Random fill the empty tiles of the curLevel with random palette items
        /// </summary>
        /// <param name="data">The current curLevel data</param>
        /// <param name="sizeX">The horizontal size of the curLevel</param>
        /// <param name="sizeY">The vertical size of the curLevel</param>
        private void RandomFillEmpty(ref LevelData[] data, int sizeX, int sizeY)
        {
            // Get the correct palette
            var palette = _savedPalette.objectReferenceValue as Palette;

            // Make sure the palette exists
            if (palette == null || palette.items == null || palette.items.Count <= 0)
            {
                return;
            }
            ...
            foreach (var item in emptyItems)
            {
                // Pick a random palette item
                var randomIndex = Random.Range(0, palette.items.Count);

                // Apply the random palette item
                item.paletteId = palette.items[randomIndex].id;
            }
        }
        ...
        /// </summary>
        /// <param name="data">The current curLevel/overlay data</param>
        ...
        /// <param name="sizeX">The horizontal size of the curLevel</param>
        /// <param name="sizeY">The vertical size of the curLevel</param>
        /// <returns>The updated curLevel data</returns>
        private LevelData[] GenerateGrid(LevelData[] data, ref bool showGrid, string title, int sizeX, int sizeY)
        {
            ...
            // Add a random fill button
            if (GUILayout.Button("Random Fill Empty"))
            {
                // Show a confirmation dialog
                if (EditorUtility.DisplayDialog($"Random Fill ({title})", "Are you sure you want to randomly fill the empty tiles of this layer? This process can not be reverted", "Yes", "No"))
                {
                    // Randomly fill the empty tiles of the layer
                    RandomFillEmpty(ref data, sizeX, sizeY);
                }
            }
            ...
            // Loop through the curLevel data
            for (var y = 0; y < sizeY; y++)
            {
                // Start the horizontal layout
                EditorGUILayout.BeginHorizontal();
